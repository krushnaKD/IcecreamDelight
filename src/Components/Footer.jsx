...
const Footer = () => {
  return (
    <div className="relative w-full h-[60vh] bg-[#683292] flex flex-col gap-2 items-center justify-center">
      ...
      <div className="absolute w-14 h-12 rounded-md right-10 bottom-10 flex items-center justify-center bg-[#F83D8E] hover:bg-blue-200"><i class="text-white text-3xl text-center ri-arrow-up-long-line"></i></div>
    </div>
  );
};
